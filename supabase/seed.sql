...
INSERT INTO
public.profiles (user_id,user_name,user_type,work_place,created_at)
VALUES
...
VALUES
  ((SELECT id FROM profiles WHERE user_id = '185f2f83-d63a-4c9b-b4a0-7e4a885799e2'), 
   '2025-01-28 09:00:00+00', '2024-12-08 07:30:00', '2024-12-08 09:30:00'),
  ((SELECT id FROM profiles WHERE user_id = '185f2f83-d63a-4c9b-b4a0-7e4a885799e2'), 
   '2025-01-28 09:00:00+00', '2024-12-08 09:30:00', '2024-12-08 12:30:00'),
  ((SELECT id FROM profiles WHERE user_id = '185f2f83-d63a-4c9b-b4a0-7e4a885799e3'), 
   '2025-01-28 09:00:00+00', '2024-12-08 09:30:00', '2024-12-08 12:30:00'),
  ((SELECT id FROM profiles WHERE user_id = '185f2f83-d63a-4c9b-b4a0-7e4a885799e1'), 
   '2025-01-28 09:00:00+00', '2024-12-08 07:30:00', '2024-12-08 09:30:00'),
  ((SELECT id FROM profiles WHERE user_id = '185f2f83-d63a-4c9b-b4a0-7e4a885799e1'), 
   '2025-01-28 09:00:00+00', '2024-12-07 07:30:00', '2024-12-07 09:30:00');
